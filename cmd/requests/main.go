...
func init() {
	...
	utilruntime.Must(requestsv1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	flag.StringVar(&enableControllers, "enable-controllers", "*",
		"Comma-separated list of controllers to enable (e.g., seerr). Use * for all.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "media-operator-requests.media-operator.dev",
	})
	if err != nil {
