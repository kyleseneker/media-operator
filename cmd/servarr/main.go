...
import (
	...
	"github.com/kyleseneker/media-operator/internal/controller/servarr"
)
...
func init() {
	...
	utilruntime.Must(servarrv1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "media-operator-servarr.media-operator.dev",
	})
	if err != nil {
