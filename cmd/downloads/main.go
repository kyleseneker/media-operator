...
func init() {
	...
	utilruntime.Must(downloadsv1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	flag.StringVar(&enableControllers, "enable-controllers", "*",
		"Comma-separated list of controllers to enable (e.g., qbittorrent,sabnzbd). Use * for all.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "media-operator-downloads.media-operator.dev",
	})
	if err != nil {
