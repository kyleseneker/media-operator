...
func init() {
	...
	utilruntime.Must(curationv1alpha1.AddToScheme(scheme))
}
...
var allControllers = []controllerFactory{
	{name: "maintainerr", setup: func(mgr ctrl.Manager) controllerSetup {
		return &curation.MaintainerrConfigReconciler{
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "media-operator-curation.media-operator.dev",
		Cache:                  cacheOptions,
	})
	if err != nil {
