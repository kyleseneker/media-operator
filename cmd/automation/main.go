...
var allControllers = []controllerFactory{
	{name: "autobrr", setup: func(mgr ctrl.Manager) controllerSetup {
		return &automation.AutobrrConfigReconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme(), Recorder: mgr.GetEventRecorderFor("autobrr-controller")}
	}},
}
...
func main() {
	...
	flag.StringVar(&enableControllers, "enable-controllers", "*",
		"Comma-separated list of controllers to enable (e.g., autobrr). Use * for all.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "media-operator-automation.media-operator.dev",
	})
	if err != nil {
