...
func init() {
	...
	utilruntime.Must(subtitlesv1alpha1.AddToScheme(scheme))
}
...
var allControllers = []controllerFactory{
	{name: "bazarr", setup: func(mgr ctrl.Manager) controllerSetup {
		return &subtitles.BazarrConfigReconciler{
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "media-operator-subtitles.media-operator.dev",
		Cache:                  cacheOptions,
	})
	if err != nil {
