...
func init() {
	...
	utilruntime.Must(transcodev1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	flag.StringVar(&enableControllers, "enable-controllers", "*",
		"Comma-separated list of controllers to enable (e.g., tdarr). Use * for all.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "media-operator-transcode.media-operator.dev",
	})
	if err != nil {
