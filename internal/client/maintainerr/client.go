...
func (c *Client) UpdatePlexSettings(ctx context.Context, settings map[string]any) error {
...
func (c *Client) UpdateSonarrSettings(ctx context.Context, settings map[string]any) error {
...
func (c *Client) UpdateRadarrSettings(ctx context.Context, settings map[string]any) error {
...
func (c *Client) UpdateOverseerrSettings(ctx context.Context, settings map[string]any) error {
...
func (c *Client) UpdateRule(ctx context.Context, id int, rule map[string]any) error {
