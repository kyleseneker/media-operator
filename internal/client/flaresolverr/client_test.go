...
func TestPing(t *testing.T) {
	c := newTestClient(t, func(w http.ResponseWriter, r *http.Request) {
		_ = json.NewEncoder(w).Encode(response{Status: "ok", Sessions: []string{}})
	})
...
func TestListSessions(t *testing.T) {
	c := newTestClient(t, func(w http.ResponseWriter, r *http.Request) {
		...
		_ = json.NewEncoder(w).Encode(response{Status: "ok", Sessions: []string{"sess1", "sess2"}})
	})
...
func TestDo_ErrorStatus(t *testing.T) {
	c := newTestClient(t, func(w http.ResponseWriter, r *http.Request) {
		_ = json.NewEncoder(w).Encode(response{Status: "error", Message: "something broke"})
	})
